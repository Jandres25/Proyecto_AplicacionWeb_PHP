    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <form action="<?php echo e(app_url('/usuarios/editar')); ?>" method="post">
                ...
                <input type="hidden" name="id" value="<?php echo e($vm->usuario->id); ?>">
                <div class="card shadow-sm border-0">
                    <div class="card-header bg-white py-3 border-bottom d-flex justify-content-between align-items-center">
                        <h5 class="card-title mb-0 fw-bold text-primary">
                            <i class="bi bi-person-gear me-2"></i>Modificar Registro
                        </h5>
                        <span class="badge bg-light text-primary border px-3 py-2">ID: <?= e($vm->usuario->id); ?></span>
                    </div>
                    <div class="card-body p-4">
                        <?php if (!empty($vm->error)) : ?>
                            <div class="alert alert-danger d-flex align-items-center" role="alert">
                                <i class="bi bi-exclamation-triangle-fill me-2"></i>
                                <div><?php echo e($vm->error); ?></div>
                            </div>
                        <?php endif; ?>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" value="<?php echo e($vm->usuario->nombres); ?>" class="form-control" name="nombres" id="nombres" required>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i class="bi bi-person"></i></span>
                                    <input type="text" value="<?php echo e($vm->usuario->apellidos); ?>" class="form-control" name="apellidos" id="apellidos" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" value="<?php echo e($vm->usuario->usuario); ?>" class="form-control" name="usuario" id="usuario" required>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="email" value="<?php echo e($vm->usuario->correo); ?>" class="form-control" name="correo" id="correo" required>
                            </div>
                        </div>
                    </div>
