...
<head>
    ...
    <title>Error <?= e((string) $vm->statusCode); ?></title>
...
<body class="bg-light">
    <main class="container min-vh-100 d-flex align-items-center justify-content-center py-5">
        <section class="card shadow-sm border-0 text-center p-4 p-md-5" style="max-width: 640px;">
            <h1 class="display-3 fw-bold text-warning mb-3"><?= e((string) $vm->statusCode); ?></h1>
            <h2 class="h4 mb-3"><?= e($vm->title); ?></h2>
            <p class="text-secondary mb-4"><?= e($vm->message); ?></p>
