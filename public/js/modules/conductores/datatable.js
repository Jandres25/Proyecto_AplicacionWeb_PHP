$(document).ready(function () {
    var table = $('#tabla_conductores').DataTable({
        responsive: true,
        autoWidth: false,
        ...
        buttons: [
            {
                ...
                buttons: [
                    ...
                    },
                    {
                        ...
                        filename: 'conductores_' + new Date().toISOString().slice(0, 10),
                        pageSize: 'LETTER',
                        ...
                        exportOptions: {
                            ...
                            format: {
                                body: function (data, row, column, node) {
                                    // Extraer texto plano del badge de teléfono y placa
                        ...
                        customize: function (doc) {
                            ...
                            doc.content.splice(1, 0, {
                                text: 'Listado de conductores registrados en el sistema',
                    ...
                    },
                    {
                        ...
                        title: 'Gestión de Conductores',
                        messageTop: 'Listado de conductores registrados',
        ...
        language: {
            ...
            sInfo: 'Mostrando registros del _START_ al _END_ de un total de _TOTAL_ conductores',
            sInfoEmpty: 'Mostrando registros del 0 al 0 de un total de 0 conductores',
            sInfoFiltered: '(filtrado de un total de _MAX_ conductores)',
            sSearch: 'Buscar:',
