$(document).ready(function () {
    var table = $('#tabla_propietarios').DataTable({
        responsive: true,
        autoWidth: false,
        ...
        buttons: [
            {
                ...
                buttons: [
                    ...
                    },
                    {
                        ...
                        filename: 'propietarios_' + new Date().toISOString().slice(0, 10),
                        pageSize: 'LETTER',
                        ...
                        customize: function (doc) {
                            ...
                            doc.content.splice(1, 0, {
                                text: 'Listado de propietarios registrados en el sistema',
                    ...
                    },
                    {
                        ...
                        title: 'Gestión de Propietarios',
                        messageTop: 'Listado de propietarios registrados',
        ...
        language: {
            ...
            sInfo: 'Mostrando registros del _START_ al _END_ de un total de _TOTAL_ propietarios',
            sInfoEmpty: 'Mostrando registros del 0 al 0 de un total de 0 propietarios',
