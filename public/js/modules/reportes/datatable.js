        ...
        buttons: [
            {
                ...
                buttons: [
                    ...
                    },
                    {
                        ...
                        filename: 'reporte_flota_' + new Date().toISOString().slice(0, 10),
                        pageSize: 'LETTER',
                        ...
                        customize: function (doc) {
                            ...
                            doc.content.splice(0, 1, {
                                text: 'REPORTE DE FLOTA',
                                style: { fontSize: 16, alignment: 'center', bold: true, margin: [0, 10, 0, 10] }
                            });
                            doc.content.splice(1, 0, {
                                text: 'Listado de taxis con propietario y conductor asignado',
                    ...
                    },
                    {
                        ...
                        title: 'Reporte de Flota',
                        messageTop: 'Listado de taxis con propietario y conductor asignado',
