$(document).ready(function () {
    var table = $('#tabla_taxis').DataTable({
        responsive: true,
        autoWidth: false,
        ...
        buttons: [
            {
                ...
                buttons: [
                    ...
                    },
                    {
                        ...
                        filename: 'taxis_' + new Date().toISOString().slice(0, 10),
                        pageSize: 'LETTER',
                        ...
                        customize: function (doc) {
                            ...
                            doc.content.splice(0, 1, {
                                text: 'GESTIÓN DE TAXIS',
                                style: { fontSize: 16, alignment: 'center', bold: true, margin: [0, 10, 0, 10] }
                            });
                            doc.content.splice(1, 0, {
                                text: 'Listado de taxis registrados en el sistema',
                    ...
                    },
                    {
                        ...
                        title: 'Gestión de Taxis',
                        messageTop: 'Listado de taxis registrados',
        ...
        language: {
            ...
            sInfo: 'Mostrando registros del _START_ al _END_ de un total de _TOTAL_ taxis',
            sInfoEmpty: 'Mostrando registros del 0 al 0 de un total de 0 taxis',
            sInfoFiltered: '(filtrado de un total de _MAX_ taxis)',
            sSearch: 'Buscar:',
